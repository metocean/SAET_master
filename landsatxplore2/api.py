...
from landsatxplore2.errors import USGSAuthenticationError, USGSError, USGSRateLimitError
...
class API(object):
    ...
    def search(
        ...
        if longitude and latitude:
            spatial_filter = SpatialFilterMbr(
                *Point(longitude, latitude).bounds)
        elif bbox:
...
class GeoJson(dict):
    ...
    def __init__(self, shape):
        ...
        self["coordinates"] = self.transform(
