...
## 1. INTRODUCTION<a name="id1"></a> index<a name="id0"></a>
...
## 2. WORKFLOW<a name="id2"></a> index<a name="id0"></a>
...
## 3. REQUIREMENTS<a name="id3"></a> index<a name="id0"></a>
...
## 4. FOLDER STRUCTURE<a name="id4"></a> index<a name="id0"></a>
...
## 5. RUNNING SAET<a name="id5"></a> index<a name="id0"></a>
...
## 6. OUTPUTS<a name="id6"></a> index<a name="id0"></a>
...
## 7. CONSIDERATIONS<a name="id7"></a> index<a name="id0"></a>
...
## 8. INSTALLATION<a name="id8"></a> index<a name="id0"></a>
